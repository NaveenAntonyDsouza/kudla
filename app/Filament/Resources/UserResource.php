    ...
    public static function infolist(Schema $infolist): Schema
    {
        return $infolist
            ->schema([
                ...
                Infolists\Components\TextEntry::make('user.email_verified_at')->label('Email Verified')->formatStateUsing(fn($state) => $state ? \Carbon\Carbon::parse($state)->format('d M Y H:i') : 'Not verified'),
                Infolists\Components\TextEntry::make('user.phone_verified_at')->label('Phone Verified')->formatStateUsing(fn($state) => $state ? \Carbon\Carbon::parse($state)->format('d M Y H:i') : 'Not verified'),
                Infolists\Components\TextEntry::make('user.last_login_at')->label('Last Login')->formatStateUsing(fn($state) => $state ? \Carbon\Carbon::parse($state)->format('d M Y H:i') : 'Never'),
