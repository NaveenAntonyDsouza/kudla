<x-layouts.app title="Search Results">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p class="text-sm text-gray-500 mb-6">
            ...
            <a href="{{ route('search.quick') }}" class="hover:text-(--color-primary)">Search</a>
            <span class="mx-1">/</span>
            <span class="text-gray-700 font-medium">Search Results</span>
        </p>

        {{-- Login CTA for guests --}}
        <div class="bg-(--color-primary-light) rounded-lg p-4 mb-6">
            <p class="text-sm text-gray-700">
                <a href="/register" class="font-semibold text-(--color-primary) hover:underline">Register free</a> or
                <a href="/login" class="font-semibold text-(--color-primary) hover:underline">login</a>
                to view full profiles, send interests, and access advanced filters.
            </p>
        </div>
        ...
        @else
            <div class="bg-white rounded-lg border border-gray-200 p-12 text-center">
                ...
                <a href="{{ $modifySearchUrl }}" class="inline-flex items-center gap-2 mt-4 px-6 py-2.5 text-sm font-semibold text-white bg-(--color-primary) hover:bg-(--color-primary-hover) rounded-lg transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-9.75 0h9.75"/></svg>
                    Modify Search
                </a>
            </div>
