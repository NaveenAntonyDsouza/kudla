<x-layouts.app title="My Matches">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p class="text-sm text-gray-500 mb-6">
            ...
            <span class="text-gray-700 font-medium">My Matches</span>
        </p>
        ...
        @if(!$hasPreferences)
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-12 text-center">
                ...
                <p class="text-sm text-gray-400 mt-2">We need to know what you're looking for to find your best matches.</p>
        ...
        @elseif($matches->count() > 0)
            ...
            <h1 class="text-lg font-semibold text-gray-900 mb-6">
                <span class="text-(--color-primary)">{{ $matches->total() }}</span> {{ Str::plural('Match', $matches->total()) }} found
            </h1>
        ...
        @else
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-12 text-center">
                ...
                <p class="text-gray-600 font-medium">No matches found yet</p>
                <p class="text-sm text-gray-400 mt-2">Try broadening your partner preferences to see more matches.</p>
                <a href="{{ route('onboarding.preferences') }}" class="inline-flex items-center gap-2 mt-4 px-6 py-2.5 text-sm font-semibold text-white bg-(--color-primary) hover:bg-(--color-primary-hover) rounded-lg transition-colors">
