            ...
            <div class="flex-1 min-w-0 space-y-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    @foreach([
                        ...
                        ['label' => 'Profile Views', 'count' => 0, 'route' => '#', 'icon' => 'M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z'],
                    ] as $stat)
