...
@php
    ...
    // Steps moved to <x-onboarding-progress :step="$step" /> — shared with
    // /manage-photos when the user arrives via the onboarding photo step.
@endphp
<!DOCTYPE html>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="flex-1 min-w-0">
                    <x-onboarding-progress :step="$step" />
