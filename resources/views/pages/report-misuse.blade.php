<x-layouts.app title="Report Misuse">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="prose prose-sm max-w-none text-gray-700 space-y-6">
            ...
            <p>Alert us by writing to us: <strong><a href="mailto:{{ \App\Models\SiteSetting::getValue('email', 'info@example.com') }}" class="text-(--color-primary) hover:underline">{{ \App\Models\SiteSetting::getValue('email', 'info@example.com') }}</a></strong>, for us to initiate necessary action against the offender.</p>
            ...
            <p>Please report anything offensive, fraudulent or suspicious with proper evidence to us by sending mail to <strong><a href="mailto:{{ \App\Models\SiteSetting::getValue('email', 'info@example.com') }}" class="text-(--color-primary) hover:underline">{{ \App\Models\SiteSetting::getValue('email', 'info@example.com') }}</a></strong></p>
        </div>
    </div>
</x-layouts.app>
