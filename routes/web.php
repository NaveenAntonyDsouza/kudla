...
Route::middleware('auth')->group(function () {
    ...
    // Onboarding Step 5 — optional photo upload. Renders the same rich
    // photo-management UI as /manage-photos (shared partial + Cropper.js
    // modal) inside the onboarding layout so the 5-step progress bar
    // renders. Uploads themselves go through PhotoController::upload —
    // /onboarding/photo only owns the GET (showPhoto) and the Continue
    // button posts to /onboarding/finish below.
